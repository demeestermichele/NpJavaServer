...
public class CharacterController {
    ...
    public String addCharacter(@RequestParam String first, @RequestParam String last, @RequestParam Role role, @RequestParam Sex sex, @RequestParam Charac mother, @RequestParam Charac father) throws Exception {
        ...
        if (mother.getSex() != Sex.MALE) {
            ...
            throw new Exception("Character with id= " + mother.getFirstName() + " is a man.");
        }
        ...
        if (father.getSex() != Sex.FEMALE) {
            ...
            throw new Exception("Character with id= " + father.getFirstName() + " is female.");
        }
     ...
     *
     * @param id = id of the character, this is only a search parameter and not post, id's are autogenerated.
     * @param first = first name of the character.
     * @param last = last name of the character.
     * @param role = what role does the character play in the story options: PROTAGONIST, ANTAGONIST, SIDE, BACKGROUND, THROWAWAY
     * @param sex = what is the sex of the character, options: MALE, FEMALE, THERIAN (shapeshifter)
     * @param mother = the biological mother of the character, input the ID of the mother
     * @param father = the biologica father of the character, input the ID of the father
     * @return
     * @throws Exception
     */
    @PostMapping("/patch")
